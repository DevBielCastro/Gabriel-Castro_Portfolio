  ...
  const skillsData = [
    ...
    },
    {
      ...
      technologies: [
        ...
        { icon: <FaCode size={24} />, name: "VS Code" },
      ],
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillsData.map((skillCategory) => (
            <div
              ...
              className="bg-primary/30 p-6 rounded-lg border border-transparent hover:border-accent/50 transition-colors"
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {skillCategory.technologies.map((tech) => (
                  <div
                    key={tech.name}
                    className="flex items-center gap-3 bg-primary/50 p-3 rounded-md transition-transform hover:scale-105 hover:bg-primary"
                  >
